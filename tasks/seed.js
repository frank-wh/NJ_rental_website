...
async function main() {
	...
	const house1 = await houses.addHouse(
		'313 7th St, Downtown, NJ 07302', 
		'Downtown Charmer - 17 Mins to NYC!', 
		user1._id, 40.726246, -74.0481387, 'Entire home/apt', 4100, ''
	);
	...
	const house2 = await houses.addHouse(
		'38 Romaine Ave, Jersey City, NJ 07306', 
		'Beautiful apt., 10 min subway ride to Manhattan', 
		user2._id, 40.730931, -74.06998, 'Entire home/apt', 2950, ''
	);
	...
	const house3 = await houses.addHouse(
		'360 Marin Blvd, Downtown, NJ 07302', 
		'HUGE PENTHOUSE LUXURY!!', 
		user3._id, 40.7212416, -74.0407989, 'Entire home/apt', 3520, ''
	);
	...
	const house4 = await houses.addHouse(
		'149 Terhune Ave, Greenville, NJ 07305', 
		'2 bedroom, minutes from bus stop to journal sq', 
		user4._id, 40.705586, -74.0969139, 'Entire home/apt', 2000, ''
	);
	...
	const house5 = await houses.addHouse(
		'133 Lafayette St, Bergen Lafayette, NJ 07304', 
		'Jersey City, 1-Bedroom Garden Apt.', 
		user5._id, 40.7136919, -74.0633154, 'Entire home/apt', 2370, ''
	);
	...
	const house7 = await houses.addHouse(
		'201 Washington St, Downtown, NJ 07302', 
		'Shared Room Downtown', 
		user7._id, 40.7140661, -74.038208, 'Shared Room', 695, ''
	);
	...
	const house8 = await houses.addHouse(
		'382 Van Horne St, Jersey City, NJ 07304', 
		'Minutes to Manhattan & Jersey Shore', 
		user8._id, 40.710149, -74.060111, 'Entire home/apt', 3180, ''
	);
	const house9 = await houses.addHouse(
		'7 Monitor St, Jersey City, NJ 07304', 
		'Minutes to Manhattan and NJ Shore', 
		user8._id, 40.7165239, -74.0580937, 'Entire home/apt', 2900, ''
	);
	...
	const house10 = await houses.addHouse(
		'138 Leonard St, Jersey City, NJ 07307', 
		'Cozy Shared Room / Free WiFi / 25 Min To Time Sq', 
		user9._id, 40.757235, -74.049168, 'Shared Room', 500, ''
	);
	...
	const house11 = await houses.addHouse(
		'175 Van Horne St, Jersey City, NJ 07304', 
		'Private room with own bathroom close to NYC', 
		user10._id, 40.7118974, -74.0652272, 'Private Room', 1190, ''
	);
	const house12 = await houses.addHouse(
		'291 Halladay St, Jersey City, NJ 07304', 
		'Large Room with private bathroom 20 min to Manhattan', 
		user10._id, 40.7125955, -74.0628522, 'Private Room', 1000, ''
	);
	...
	const house13 = await houses.addHouse(
		'11 Saddlewood Ct, Downtown, NJ 07302', 
		'1500sf 1BR Loft: Open Plan+NYC View', 
		user11._id, 40.721962, -74.041651, 'Entire home/apt', 4200, ''
	);
	...
	const house14 = await houses.addHouse(
		'321 8th St, Jersey City, NJ 07302', 
		'Your Own Apartment Two Stops Away', 
		user12._id, 40.7269078, -74.0479109, 'Entire home/apt', 3600, ''
	);
	...
	const house15 = await houses.addHouse(
		'201 Newark Ave, Downtown, NJ 07302', 
		'LARGE SUNNY ROOM 15 MIN to NYC!', 
		user13._id, 40.7215897, -74.0464906, 'Private Room', 1500, ''
	);
	...
	const house16 = await houses.addHouse(
		'410 Marin Blvd, Downtown, NJ 07302', 
		'Lavish 2BR in Jersey City + Great Amenities', 
		user14._id, 40.7241331, -74.0374535, 'Hotel Room', 5000, ''
	);
